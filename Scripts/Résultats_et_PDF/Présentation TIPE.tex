...
\begin{document}
   ...
   \begin{frame}
	...
	\begin{frame}
		...
		\begin{center}
			\begin{tabular}{cc}
				\includegraphics[scale=0.175]{Resultats/5points.png}
				&
				\includegraphics[scale=0.175]{Resultats/10points.png}
				\\
				\small{5 points}&\small{10 points}
				\\
				\includegraphics[scale=0.175]{Resultats/20points.png}
				&
				\includegraphics[scale=0.175]{Resultats/50points.png}
				\\
				\small{20 points}&\small{50 points}
			\end{tabular}
		\end{center}
	\end{frame}
