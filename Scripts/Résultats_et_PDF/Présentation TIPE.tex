...
\begin{document}
   ...
   \begin{frame}
	...
	\begin{frame}
		\begin{figure}
			\includegraphics[scale=1.3]{Resultats/principe-2-opt.png}
			\caption{Principe du 2-opt: Suppression des liaisons sécantes}	
		\end{figure}
	\end{frame}
	...
	\begin{frame} 
		Comparaison et mise en avant du problème soulevé par le 2-opt (cas des trois points)
	\end{frame}
